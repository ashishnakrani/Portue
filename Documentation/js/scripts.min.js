jQuery(function () {
    var t = $(".section-txt"), r = $("nav ul li"), n = jQuery(window).width();
    n > 768 ? $(window).on("scroll", function () {
        var n = $(this).scrollTop();
        t.each(function () {
            var o = $(this).offset().top, e = o + $(this).outerHeight();
    ...
    var t = $("aside"), r = $(window).scrollTop(), n = jQuery(window).width();
    n > 768 && (r > 130 ? t.addClass("fixed") : t.removeClass("fixed"))
}), $(document).ready(function () {
    prettyPrint(), $(".menu-box a").click(function () {
        return $("html, body").animate({scrollTop: $($(this).attr("href")).offset().top - 30 + "px"}, {duration: 800}), !1
    })
});